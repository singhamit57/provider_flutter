...
//get Document list
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: appBarWidget(languages.btnVerifyId,
          textColor: white, color: context.primaryColor),
      body: Stack(
        children: [
          AnimatedScrollView(
              ...
              Observer(builder: (context) {
                return AnimatedListView(
                  ...
                  itemBuilder: (context, index) {
                    return providerDocuments[index]
                            .providerDocument!
                            .contains('.pdf')
                        ? Container(
                            ...
                            child: Column(
                              children: [
                                Text(providerDocuments[index].providerDocument!,
                                    style: primaryTextStyle()),
                                Row(
                                  ...
                                  children: [
                                    ...
                                    Container(
                                      ...
                                      getMultipleFile(
                                          ...
                                          updateId: providerDocuments[index]
                                              .id
                                              .validate());
                                    }).visible(
                                        providerDocuments[index].isVerified ==
                                            0),
                                    6.width,
                                    Container(
                                      padding: EdgeInsets.all(6),
