...
//region Status
const APPROVED_BY_HANDYMAN =
    "approved_by_handyman"; //- Handyman approved the request
...
const PENDING_BY_PROVIDER =
    "pending_by_provider"; //- Request pending with the provider
const APPROVED_BY_PROVIDER =
    "approved_by_provider"; //- Provider approved the request
