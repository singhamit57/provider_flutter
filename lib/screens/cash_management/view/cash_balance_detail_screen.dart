...
import 'package:koibanda_provider_flutter/components/base_scaffold_widget.dart';
import 'package:koibanda_provider_flutter/components/empty_error_state_widget.dart';
import 'package:koibanda_provider_flutter/components/price_widget.dart';
import 'package:koibanda_provider_flutter/main.dart';
import 'package:koibanda_provider_flutter/screens/cash_management/cash_repository.dart';
import 'package:koibanda_provider_flutter/screens/cash_management/component/cash_info_widget.dart';
import 'package:koibanda_provider_flutter/screens/cash_management/component/cash_list_widget.dart';
import 'package:koibanda_provider_flutter/screens/cash_management/component/status_widget.dart';
import 'package:koibanda_provider_flutter/screens/cash_management/model/cash_filter_model.dart';
import 'package:koibanda_provider_flutter/screens/cash_management/model/payment_history_model.dart';
...
class _CashBalanceDetailScreenState extends State<CashBalanceDetailScreen> {
  ...
  Widget buildTodayCashWidget(
      {required num todayCash, required num totalCash}) {
    return Container(
      height: 120,
          ...
          Positioned(
            ...
            child: Container(
              ...
              child: Column(
                children: [
                  Text(
                      "${getDateInString(dateTime: filterDate!, format: DATE_FORMAT_2)} ${languages.cash}",
          ...
          Row(
            children: [
              Text(languages.cashList,
                  ...
                  .expand(),
              Text('${cashFilterList[currentFilterIndex].name.validate()}',
                  style: secondaryTextStyle()),
              IconButton(
                onPressed: () {
                                  ...
                                  onChanged: (index) async {
                                    ...
                                    if (currentFilterIndex == 2) {
                                      ...
                                      filterDate = DateTimeRange(
                                          ...
                                          end: DateTime.now().subtract(1.days));
                                      updateList();
