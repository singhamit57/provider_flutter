...
import 'package:koibanda_provider_flutter/components/image_border_component.dart';
import 'package:koibanda_provider_flutter/components/price_widget.dart';
import 'package:koibanda_provider_flutter/main.dart';
import 'package:koibanda_provider_flutter/models/user_bank_model.dart';
                ...
                child: AppButton(
                  onTap: () {
                    if (selectedPaymentList == null)
                      return toast(languages.choosePaymentMethod);
