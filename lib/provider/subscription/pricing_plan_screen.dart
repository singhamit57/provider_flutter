...
import 'package:koibanda_provider_flutter/provider/payment/payment_screen.dart';
              ...
              return AnimatedScrollView(
                ...
                children: [
                  ...
                  Text(languages.lblSelectPlan, style: boldTextStyle(size: 16))
                      .center(),
                  8.height,
                  Text(languages.selectPlanSubTitle,
                  ...
                  AnimatedListView(
                    ...
                    padding:
                        EdgeInsets.only(bottom: 90, top: 8, right: 8, left: 8),
                                  ...
                                  children: [
                                    ...
                                    Column(
                                      ...
                                      children: [
                                        Row(
                                          children: [
                                            Text('${data.identifier.capitalizeFirstLetter()}',
                                                    style: boldTextStyle())
                                                .flexible(),
              ...
              child: AppButton(
                ...
                onTap: () async {
                  if (selectedPricingPlan!.identifier == FREE) {
                    ...
                    await saveSubscription(planRequestModel.toJson())
                        .then((value) {
  ...
  Widget getPlanStatus({required LimitData limitData, required String name}) {
    if (limitData.isChecked == null) {
      return RichTextWidget(
        list: [
          TextSpan(
              text: '${languages.unlimited} $name', style: primaryTextStyle()),
        ],
      );
      ...
      return RichTextWidget(
        list: [
          ...
          TextSpan(
              text: '0',
              style: boldTextStyle(
                  color: primaryColor, decoration: TextDecoration.lineThrough)),
        ],
      );
    } else {
      return RichTextWidget(
