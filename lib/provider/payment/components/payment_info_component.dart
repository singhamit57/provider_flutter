                        ...
                        children: [
                          Row(
                            ...
                            children: [
                              ...
                              index != 0
                                  ? PriceWidget(price: data.totalAmount.validate(), size: 16)
                                  : PriceWidget(price: data.totalAmount.validate() + data.extraCharges.validate().sumByDouble((p0) => p0.total), size: 16),
                            ],
                          ),
                        ],
                      ),
