...
import 'package:koibanda_provider_flutter/components/custom_image_picker.dart';
import 'package:koibanda_provider_flutter/main.dart';
import 'package:koibanda_provider_flutter/models/attachment_model.dart';
...
import 'package:koibanda_provider_flutter/provider/services/components/category_sub_cat_drop_down.dart';
import 'package:koibanda_provider_flutter/provider/services/components/service_address_component.dart';
          ...
          children: [
              ...
              children: [
                ...
                AppTextField(
                  ...
                  validator: (s) {
                    ...
                    if (s.toDouble().isNegative || s.toInt() > 99)
                      return '${discountCont.text}% ${languages.isNotValid}';
                    return null;
                  },
                ).expand(),
              ],
            ...
            AppTextField(
              ...
              onTap: () async {
                ...
                if (currentTime != null) {
                  durationContHr.text =
                      "${languages.thisServiceMayTake} ${currentTime!.hour}:${currentTime!.minute} ${languages.hour}";
                }
              },
              errorThisFieldRequired: languages.hintRequired,
              decoration: inputDecoration(
