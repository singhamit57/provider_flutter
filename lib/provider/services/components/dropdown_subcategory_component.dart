...
class DropdownSubCategoryComponent extends StatefulWidget {
  ...
  @override
  _DropdownUserTypeComponentState createState() =>
      _DropdownUserTypeComponentState();
}

class _DropdownUserTypeComponentState
    extends State<DropdownSubCategoryComponent> {
