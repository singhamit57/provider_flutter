...
import 'package:koibanda_provider_flutter/provider/service_address/components/add_service_component.dart';
    ...
    await getAddresses(providerId: appStore.userId).then((value) {
      ...
      if (widget.selectedList != null) {
        addressList.forEach((element) {
          ...
          element.isSelected =
              widget.selectedList!.contains(element.id.validate());
        });

        widget.onSelectedList.call(addressList
      ...
      children: [
        ...
        Align(
          ...
          child: TextButton(
            ...
            child: Text(languages.lblAddServiceAddress,
