...
import 'package:koibanda_provider_flutter/provider/timeSlots/components/days_component.dart';
import 'package:koibanda_provider_flutter/provider/timeSlots/components/disclaimer_widget.dart';
import 'package:koibanda_provider_flutter/provider/timeSlots/components/slot_component.dart';
import 'package:koibanda_provider_flutter/provider/timeSlots/edit_time_slot_screen.dart';
import 'package:koibanda_provider_flutter/provider/timeSlots/models/slot_data.dart';
import 'package:koibanda_provider_flutter/provider/timeSlots/services/time_slot_services.dart';
  ...
  Widget build(BuildContext context) {
    List<String> temp = timeSlotsList.isNotEmpty
        ? timeSlotsList
            .firstWhere(
                (element) =>
                    element.day!.toLowerCase() == selectedDay.toLowerCase(),
