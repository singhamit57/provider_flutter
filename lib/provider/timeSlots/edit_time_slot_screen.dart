...
import 'package:koibanda_provider_flutter/provider/timeSlots/components/available_slots_component.dart';
import 'package:koibanda_provider_flutter/provider/timeSlots/components/days_bottom_sheet.dart';
        ...
        children: [
          SingleChildScrollView(
            child: Column(
              ...
              children: [
                Text(languages.selectYourDay, style: boldTextStyle())
                    ...
                    return GestureDetector(
                      ...
                      child: Container(
                        ...
                        decoration: boxDecorationWithRoundedCorners(
                          backgroundColor:
                              isSelected ? primaryColor : context.cardColor,
                          borderRadius: BorderRadius.circular(defaultRadius),
                        ),
                        child: Text(
                          data.validate(),
                          style: appStore.isDarkMode
                              ? boldTextStyle(color: white)
                              : boldTextStyle(
                                  color:
                                      isSelected ? white : appTextPrimaryColor),
                        ),
                      ),
                    );
                  },
                ...
                Row(
                  ...
                  children: [
                    Text(languages.chooseTime,
                        style: boldTextStyle(size: LABEL_TEXT_SIZE)),
                    TextButton(
                      child:
                          Text(languages.copyTo, style: secondaryTextStyle()),
                      onPressed: () async {
