...
import 'package:koibanda_provider_flutter/provider/timeSlots/components/slot_widget.dart';
      ...
      builder: (context) {
        return Container(
          ...
          child: Column(
            ...
            children: [
              Text(languages.lblTime, style: boldTextStyle())
                  .paddingOnly(top: 8, bottom: 16, left: 8, right: 16),
              if (widget.timeSlotList.isNotEmpty)
                  ...
                  children: widget.timeSlotList
                      .map(
                        (slot) => SlotWidget(
                          ...
                          isWhiteBackground: appStore.isDarkMode
                              ? scaffoldDarkColor
                              : Colors.white,
                          value: slot.validate(),
                          onTap: () {
                ...
                Text(languages.noSlotsAvailable, style: secondaryTextStyle())
                    .paddingAll(16)
                    .center(),
            ],
          ),
