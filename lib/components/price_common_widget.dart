                  ...
                  children: [
                    ...
                    PriceWidget(
                      price: calculateTotalAmount(
                        servicePrice: bookingPackage!.price.validate(),
                        taxes: bookingDetail.taxes,
                        couponData: bookingDetail.couponData,
                        extraCharges: bookingDetail.extraCharges,
                      ),
                      color: primaryColor,
                      size: 16,
                    ),
                          ...
                          Marquee(
                            child: Row(
                              children: [
                                ...
                                PriceWidget(price: bookingDetail.amount.validate() * bookingDetail.quantity.validate(value: 1), isBoldText: true, color: textPrimaryColorGlobal),
                              ],
                            ),
                          ).flexible(flex: 2),
                        ],
                    ...
                    children: [
                      Row(
                        children: [
                          ...
                          Text(" (${couponData!.code})", style: secondaryTextStyle(size: 12, color: primaryColor)),
                        ],
                      ),
                      PriceWidget(
                          ...
                          if (bookingDetail.isHourlyService)
                            Row(
                              ...
                              children: [
                                ...
                                PriceWidget(price: getTotalValueForHour, color: appTextSecondaryColor, size: 12, isBoldText: false),
                ...
                if (serviceDetail.isAdvancePayment)
                  Row(
                    children: [
                      ...
                      PriceWidget(price: getAdvancePaymentAmount, color: primaryColor, size: 16),
                    ],
                  ),
