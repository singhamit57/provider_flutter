                  ...
                  if (widget.bookingData.bookingPackage != null)
                    PriceWidget(
                      price: calculateTotalAmount(
                        servicePrice: widget.bookingData.bookingPackage!.price.validate(),
                        taxes: widget.bookingData.taxes,
                        couponData: widget.bookingData.couponData,
                      ...
                      children: [
                        if (widget.bookingData.bookingType == BOOKING_TYPE_SERVICE)
                          PriceWidget(
                            ...
                            price: calculateTotalAmount(
                              servicePrice: (widget.bookingData.isHourlyService && widget.bookingData.status == BookingStatusKeys.complete)
                                  ? hourlyCalculationNew(
                                      price: widget.bookingData.amount.validate(),
                                      secTime: widget.bookingData.durationDiff.validate().toInt(),
                                    )
                          ...
                          Row(
                            children: [
                              ...
                              PriceWidget(
                                price: calculateTotalAmount(
                                  serviceDiscountPercent: widget.bookingData.discount.validate(),
                                  qty: widget.bookingData.quantity.validate(value: 1).toInt(),
                                  servicePrice: widget.bookingData.amount.validate(),
                                  taxes: widget.bookingData.taxes,
                                  couponData: widget.bookingData.couponData,
                                  extraCharges: widget.bookingData.extraCharges.validate(),
                                ),
                                color: textSecondaryColorGlobal,
                                isBoldText: false,
                                size: textSecondarySizeGlobal,
                              ),
                              Text(languages.lblHourly, style: secondaryTextStyle()).paddingSymmetric(horizontal: 4),
                            ],
                          )
                        else
                          4.width,
                    ...
                    Column(
                      children: [
                        ...
                        Row(
                          ...
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            Text(languages.Koibanda, style: secondaryTextStyle()),
